...
def game_init():
    pygame.init()
    pygame.display.set_caption('Fast_and_Curious')
...
def game_loop():
    ...
    while not gameExit:
        ...
        load_image(80, tree_y_left, 'images/strip.jpg')
        load_image(700, tree_y_right, 'images/white.jpg')
        load_image(x,y, 'images/yellow.png')
